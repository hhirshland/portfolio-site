...
export default function CaseStudyCard({ caseStudy, isStacked = false }: CaseStudyCardProps) {
  return (
    <Link href={`/case-studies/${caseStudy.slug}`}>
      <div className={`group relative bg-white/60 backdrop-blur-sm rounded-3xl border border-white/50 shadow-lg shadow-emerald-900/5 overflow-hidden transition-all duration-300 ${
        isStacked 
          ? 'pointer-events-none' 
          : 'hover:shadow-xl hover:shadow-emerald-900/10 hover:-translate-y-1'
      }`}>
